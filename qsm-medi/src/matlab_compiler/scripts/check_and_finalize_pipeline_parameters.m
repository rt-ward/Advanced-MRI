function [delta_TE,TE,B0_dir,B0_mag,phase_encoding_dir]=check_and_finalize_pipeline_parameters(json_params,nifti_params,matrix_size,phase_corr)
    format long
    ...
    for param = ["delta_TE","TE","B0_dir","B0_mag","phase_encoding_dir"]
    ...
    if phase_corr == 1 & isempty(phase_encoding_dir)
        disp('WARN: phase_encoding_dir was not found in imaging data or provided by user.');
    end
